    ...
    <div id="sidebar">
        <ul>
            ...
            >
                <router-link
                    :to="{ name: 'products' }"
                    @click.native="changeActive($event)"
            ...
            <li
                id="nav-2"
                :class="[$route.name == 'createProducts' ? 'active' : '']"
            >
                <router-link
            ...
            <li
                id="nav-4"
                :class="[$route.name == 'createRole' ? 'active' : '']"
            >
                <router-link
                    :to="{ name: 'createRole' }"
                    @click.native="changeActive($event)"
            ...
            <li
                ...
                :class="[
                    ...
                    $route.name == 'viewPermission' ||
                    $route.name == 'editPermission'
                        ? 'active'
                        : '',
                ]"
            >
                <router-link
                    :to="{ name: 'permissions' }"
                    @click.native="changeActive($event)"
                    >All Permissions</router-link
                >
            </li>
            <li
                id="nav-6"
                :class="[$route.name == 'createPermission' ? 'active' : '']"
            >
                <router-link
