<template>
    ...
    <div
        style=""
        class="d-flex no-auth"
        v-else-if="permissions.viewAll_index == false"
    >
    ...
    <section id="all-permissions" class="view-table" v-else>
        ...
        <div v-if="retrieveMessage2.response_index" class="text-center">
            <h6
                v-for="(message, index) in retrieveMessage2.response_message"
                :key="index"
                :class="[
                    retrieveMessage2.response_type == 'Error'
                        ? 'text-danger'
                        : 'text-success',
                    'font-20',
                    'my-3',
        ...
        <table class="table table-striped table-bordered table-hover table-sm">
            ...
            <tbody>
                <tr
                    v-for="(permission, index) in permissions.data.data"
                    :key="index"
                >
                    <td>
                        {{
                    ...
                    <td>
                        <ol>
                            <li v-for="(role, index) in permission.roles">
                                {{ role.name }}
                            </li>
                        </ol>
                    </td>
