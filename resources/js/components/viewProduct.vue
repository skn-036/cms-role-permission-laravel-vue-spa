<template>
    ...
    <section id="view-product" v-else>
        ...
        <h5 class="mb-2">
            <strong>Product Id: </strong> {{ product.data.id }}
        </h5>
        <h5 class="mb-2">
            <strong>Product Brand: </strong> {{ product.data.brand }}
        </h5>
        <h5 class="mb-2">
            <strong>Product Model: </strong> {{ product.data.model }}
        </h5>
        <h5 class="mb-2">
            <strong>Product Category: </strong> {{ product.data.category }}
        </h5>
        <h5 class="mb-2">
            <strong>Product Price: </strong> $ {{ product.data.price }}
        </h5>
        <h5 class="mb-2">
            <strong>Product Discount: </strong> {{ product.data.discount }}%
        </h5>
        <h5 class="mb-2">
            <strong>Product Discount Price: </strong> $
            {{ product.data.discount_price }}
        </h5>
        <h5 class="mb-2">
            <strong>Product Rating: </strong> {{ product.data.rating }}
        </h5>
