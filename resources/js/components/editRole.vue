<template>
    ...
    <div
        ...
        v-else-if="editRoleInputs.index == false"
    >
    ...
    <section id="new-product" v-else>
        ...
        <div class="row d-flex flex-row text-center">
            <select
                class="w-50 mx-3 border-radius-5px"
                v-model="permId"
                multiple
            >
                <option
                    v-for="(perm,
                    index) in editRoleInputs.not_granted_permissions"
                    :key="index"
                    :value="perm.id"
                >
                    {{ perm.name }}
        ...
        <div class="row d-flex flex-row text-center">
            ...
            >
                <option
                    v-for="(perm, index) in editRoleInputs.granted_permissions"
                    :key="index"
                    :value="perm.id"
                >
                    {{ perm.name }}
