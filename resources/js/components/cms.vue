<template>
    ...
    <div
        ...
        v-else-if="
            loginResponse.authenticated && authUser.role_type == 'administrator'
        "
    >
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <div
                    class="row mt-2 mb-4 border-bottom-999 d-flex justify-content-between align-items-center mx-2"
                >
    ...
    <div
        style=""
        class="d-flex unauthorized"
        v-else-if="
            loginResponse.authenticated &&
                authUser.role_type !== 'administrator'
        "
    >
        ...
        <div class="d-flex flex-column m-auto">
            ...
            <h5 class="text-center">
                Users are not authorized to access CMS panel. Go back and log in
                with administrative account to proceed futher
            </h5>
        </div>
    </div>
